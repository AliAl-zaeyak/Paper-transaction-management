...
<html>
    ...
    <body dir="rtl"  >
            <nav class="navbar navbar-expand-lg navbar-primary bg-primary">
              ...
              <form method="post" action="{{route('login')}}" style="width: 40%; margin-right: 30%;">
                @csrf
               <br> <h2 style="color: #0082e6">تسجيل الدخول</h2> <br>
                ...
                <div class="item-group">
                  <input type="submit"  value="تسجيل الدخول" class="btn btn-outline-primary">
                </div>
              </form>
